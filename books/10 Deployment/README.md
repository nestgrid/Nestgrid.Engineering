...
Safe deployment depends on automation, configuration discipline, validation and clear release ownership.

## Purpose

To establish deployment practices that support reliable, controlled and traceable delivery of software.

## Objectives

Upon completing this book, engineers should be able to:

- Define a release strategy appropriate to the solution.
- Use automation to reduce deployment risk.
...
1. [01 Release Strategy](01%20Release%20Strategy.md)
2. [02 Deployment Automation](02%20Deployment%20Automation.md)
3. [03 Environment Management](03%20Environment%20Management.md)
