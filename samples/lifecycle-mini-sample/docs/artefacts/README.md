...
The Lifecycle Mini Sample does not include a full set of workflow artefacts.

This directory is included to demonstrate the recommended product repository structure.
