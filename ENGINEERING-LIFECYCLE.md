...
The lifecycle is guided by several core principles.
...
- Produce documentation that evolves alongside the software.

Following these principles enables engineering teams to deliver software that is understandable, maintainable and resilient.
