...
- Nestgrid.Engineering maintainers

## Context

Nestgrid.Engineering defines the methodology, standards and practices used across Nestgrid software engineering.
...
Nestgrid.Engineering will use Markdown-first documentation with GitHub as the source of truth.

Documentation will be organised as plain Markdown files under `docs/`, supported by reusable templates under `templates/` and examples under `samples/`.
...
This approach also makes the handbook easier for engineers and AI tools to consume directly from the repository.
